...
# variables included: population, race/ethnicity, health insurance, rurality, 
...
demodata <- st_drop_geometry(demodata)

# write to csv
if (FALSE) {
  write.csv(demodata, "data/processed_data/demodata.csv")
}
